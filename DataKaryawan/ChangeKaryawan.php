        ...
        if($searchKaryawan == "x" || $searchKaryawan == "X"){
            ...
            if($succes){
                ...
                if($question == "y" || $question == "Y"){
                    ...
                    $dataKaryawan[$key][1] = ucwords($nameKaryawan);
                    $dataKaryawan[$key][2] = ucwords($jenisKelamin);
                    $dataKaryawan[$key][3] = $nikKaryawan;
                    $dataKaryawan[$key][4] = ucwords($statusKaryawan);
                    $dataKaryawan[$key][5] = ucwords($addresKaryawan);
